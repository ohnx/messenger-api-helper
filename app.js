...
function receivedMessage(event) {
  ...
  if (messageText) {
    receive_callback(senderID, timeOfMessage, recipientID, messageText, false);
  } else if (messageAttachments) {
    receive_callback(senderID, timeOfMessage, recipientID, messageAttachments, true);
  }
}
 ...
 *
 */
var sendImageMessage = function(recipientId, imageURL) {
  var messageData = {
    recipient: {
      id: recipientId
    },
 ...
 *
 */
var sendAudioMessage = function(recipientId, audioURL) {
  var messageData = {
    recipient: {
      id: recipientId
    },
 ...
 *
 */
var sendVideoMessage = function(recipientId, videoURL) {
  var messageData = {
    recipient: {
      id: recipientId
    },
 ...
 *
 */
var sendFileMessage = function(recipientId, fileURL) {
  var messageData = {
    recipient: {
      id: recipientId
    },
 ...
 *
 */
var sendNormalMessage = function(recipientId, messageText) {
  var messageData = {
    recipient: {
      id: recipientId
    },
...
module.exports.sendNormalMessage = sendNormalMessage;
...
module.exports.sendTypingStatus = function(recipientId, status) {
    if (status) sendTypingOn(recipientId);
    else sendTypingOff(recipientId);
};
...
module.exports.start = function(message_callback, port) {
